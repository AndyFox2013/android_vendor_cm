...
CYAN_DREAM_VERSION_MAJOR := 1
CYAN_DREAM_VERSION_MINOR := 0
CYAN_DREAM_VERSION_MAINTENANCE := 0
CYAN_DREAM_VERSION := $(CYAN_DREAM_VERSION_MAJOR).$(CYAN_DREAM_VERSION_MINOR)$(CYAN_DREAM_VERSION_MAINTENANCE)-$(shell date +%0d%m%Y-%H%M%S)
CYAN_DREAM_VERSION_NUMBER := $(shell date +%s)
CYAN_DREAM_BUILDDATE := $(shell date -u +%Y%m%d)

CM_VERSION := CyanDream-v$(CYAN_DREAM_VERSION)
